// Escena default de ThinkingIndicator (avión + nubes) — extraída de ahí
// (2026-08-31) para poder reusarla como una escena más dentro del ciclo de
// alternancia tema↔avión, en vez de vivir hardcodeada como el único
// fallback "sin tema". Mismas clases fv-thinker-* de siempre (index.css),
// nada de CSS nuevo.
interface SceneProps {
  className?: string;
}

export function PlaneScene({ className }: SceneProps = {}) {
  return (
    <svg width="64" height="42" viewBox="0 0 64 42" fill="none" aria-hidden="true" className={className}>
      <path
